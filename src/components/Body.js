...
// we will crearte single resposnibility priciple --> where a fucntion will do a single thing, here our body component is fetching the api and showing the restaurants as well 
...
return listOfRestaurants.length === 0 ? (
  ...
  <div className="container mx-auto px-4 py-8">
    ...
    {/* Restaurant grid container with 4rem gap */}
